...
public class PatternsUtil {
    ...
    /*private static final String GOOD_GTLD_CHAR =
            "a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF";*/
    private static final String GOOD_GTLD_CHAR =
            "aero|arpa|asia|blz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|post|pro|tel|trave";
    private static final String GOOD_CCTLD_CHAR =
    ...
    private static final String GTLD = "(" + GOOD_GTLD_CHAR + ")";
    private static final String CCTDL = "(" + GOOD_CCTLD_CHAR + ")";
    private static final String HOST_NAME = "(" + IRI + "\\.)+" + "(" + GTLD + "|" + CCTDL + ")";
